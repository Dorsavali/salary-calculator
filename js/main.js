...
let firstnameGet = firstnameInput.value
 ...
 lastnameContainer.insertAdjacentElement("beforeend", lastnameLbl);
  ...
  calcBtn.addEventListener("click" , function(e){
      ...
      function calcSalary(clockInput, taxInput, price) {
        ...
        function salary(degree, clockInput, taxInput) {
          switch (degree) {
            case "Diploma":
        ...
        let result = salary(degree, clock, taxInput);
        let print = `<h2>Mr/Mrs ${firstnameGet} ${lastnameInput}, your salary is ${result} Rials</h2>`
        answer.insertAdjacentHTML("beforeend",print)
    })
});
